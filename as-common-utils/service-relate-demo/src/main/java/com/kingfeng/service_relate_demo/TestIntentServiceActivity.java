...
import com.kingfeng.service_relate_demo.service.UploadPicIntentService;
...
public class TestIntentServiceActivity extends AppCompatActivity {
    ...
    private BroadcastReceiver uploadImgReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction() == UPLOAD_RESULT) {
                String path = intent.getStringExtra(UploadPicIntentService.EXTRA_IMG_PATH);
                handleResult(path);
            }
        }
    };
    ...
    public void addTask(View view) {
        ...
        UploadPicIntentService.startUploadImg(this, path);
